...
export function Company(props) {
  ...
  return (
    <div key={"k-" + props.company.id} className="company" role="listitem">
      <a href={props.company.url} target="_blank">
        {" "}
      </a>
      <div className="company-child logo">
        <img
          ...
          src={props.company.smallLogoUrl}
        />
      </div>
      <div className="company-child information">
        ...
        <div>
          <div className="company-pill-wrapper">
            <span className="company-pill">{props.company.batch} </span>
